function gpsPvt = GpsWelshPvt(gnssMeas,allGpsEph,bRaw)
...
xo =zeros(4,1);%initial state: [center of the Earth, bc=0, velocities = 0]'
...
%     xo(5:7) = zeros(3,1); %initialize speed to zero
    [xHat,~,~,H] = WelshPvt(prs,gpsEph,xo);%compute WLS solution
    xo = xo + xHat;
